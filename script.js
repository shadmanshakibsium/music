...
function updateRepeatUI(){
  if(repeatMode==='none') repeatBtn.style.color='var(--white)';
  if(repeatMode==='all') repeatBtn.style.color='var(--accent-2)';
  if(repeatMode==='one') repeatBtn.style.color='var(--accent-1)';
}
